  ...
  return (
    <Container onClick={props.onClick}>
      {props.isBack ? (
        ...
        >
          <g transform="translate(-23 -55.45)">
            <path
              d="M16.757,1.5H0A1.5,1.5,0,0,1-1.5,0,1.5,1.5,0,0,1,0-1.5H16.757a1.5,1.5,0,0,1,1.5,1.5A1.5,1.5,0,0,1,16.757,1.5Z"
              transform="translate(24.5 56.95)"
            />
            <path
              d="M17,1.5H0A1.5,1.5,0,0,1-1.5,0,1.5,1.5,0,0,1,0-1.5H17A1.5,1.5,0,0,1,18.5,0,1.5,1.5,0,0,1,17,1.5Z"
              transform="translate(24.5 65.5)"
            />
            <path
              d="M17,1.5H0A1.5,1.5,0,0,1-1.5,0,1.5,1.5,0,0,1,0-1.5H17A1.5,1.5,0,0,1,18.5,0,1.5,1.5,0,0,1,17,1.5Z"
              transform="translate(24.5 73.952)"
            />
          </g>
        </svg>
      )}
